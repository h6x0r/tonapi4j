...
public class BlockchainMethod extends AsyncTonapiClientBase {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<BlockchainBlockShards> getBlock(Long masterchainSeqno)
      throws TONAPIError {
   ...
   * according to shards last blocks snapshot in masterchain.
   *
   * @param masterchainSeqno Masterchain block seqno
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<Transactions> getTransactionsShards(Long masterchainSeqno)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<BlockchainConfig> getBlockchainConfig(Long masterchainSeqno)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<RawBlockchainConfig> getRawBlockchainConfig(Long masterchainSeqno)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<Transactions> getTransactionFromBlock(String blockId)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<Transaction> getTransactionData(String transactionId)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<BlockchainRawAccount> getAccountInfo(String accountId)
      throws TONAPIError {
   ...
   * @return CompletableFuture of MethodExecutionResult object containing the result of the method
   * execution
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<MethodExecutionResult> executeGetMethod(
    ...
    String method = String.format("v2/blockchain/accounts/%s/methods/%s", accountId,
        methodName);
    Map<String, Object> params = new HashMap<>();
   ...
   *
   * @param accountId Account ID
   * @return CompletableFuture of BlockchainAccountInspect object containing the account inspection
   * data
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<BlockchainAccountInspect> inspectAccount(String accountId)
      throws TONAPIError {
