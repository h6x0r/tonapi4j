...
public class JettonsMethod extends AsyncTonapiClientBase {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<JettonHolders> getHolders(String jettonId, int limit, int offset)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<JettonTransferPayload> getJettonTransferPayload(String jettonId,
      String accountId) throws TONAPIError {
