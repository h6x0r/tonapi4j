...
public class LiteserverMethod extends AsyncTonapiClientBase {
   ...
   * @return CompletableFuture of RawMasterChainInfoExt object containing the extended masterchain
   * info
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<RawMasterChainInfoExt> getMasterchainInfoExt(int mode)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<RawBlockHeader> getRawHeader(String blockId, int mode)
      throws TONAPIError {
   ...
   *
   * @param bodyMsg the base64 serialized bag-of-cells Example ->
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<RawAccountState> getAccountState(String accountAddress,
      String targetBlock) throws TONAPIError {
    ...
    return this.get(method, params.isEmpty() ? null : params, null,
        new TypeReference<RawAccountState>() {
        });
  }
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<RawShardInfo> getShardInfo(String blockId, Long workchain, Long shard,
      boolean exact) throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<RawTransactions> getRawTransactions(String accountId, long lt,
      String hash, int count) throws TONAPIError {
   ...
   * @return CompletableFuture of RawListBlockTransactions object containing the list of block
   * transactions
   * @throws TONAPIError if the request fails
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<RawBlockProof> getBlockProof(String knownBlock, int mode,
      String targetBlock) throws TONAPIError {
