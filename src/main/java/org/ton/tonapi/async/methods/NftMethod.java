...
public class NftMethod extends AsyncTonapiClientBase {
   ...
   */
  public CompletableFuture<NftCollections> getCollections(int limit, int offset)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<NftCollection> getCollectionByCollectionAddress(String accountId)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<NftItems> getItemsByCollectionAddress(String accountId, int limit,
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<NftItems> getAllItemsByCollectionAddress(String accountId)
      throws TONAPIError {
  ...
  private void fetchItems(String accountId, int limit, AtomicInteger offset,
    ...
    this.getItemsByCollectionAddress(accountId, limit, offset.get())
        .thenAccept(result -> {
          ...
          if (result.getNftItems() == null || result.getNftItems().isEmpty()
              || result.getNftItems().size() < limit) {
