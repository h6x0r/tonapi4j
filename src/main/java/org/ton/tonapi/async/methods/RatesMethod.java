...
public class RatesMethod extends AsyncTonapiClientBase {
     ...
     *
     * @param tokens     List of tokens. Accepts TON and jetton master addresses.
     *                   Example: ["TON", "UQB8ANV_ynITQr1qHXADHDKYUAQ9VFcCRDZB7h4aPuPKuFtm"]
     * @param currencies List of currencies. Accepts TON and all possible fiat currencies.
     *                   Example: ["TON","USD", "RUB"]
     * @return CompletableFuture of Rates object containing the rates information
     * @throws TONAPIError if the request fails
     */
    public CompletableFuture<Rates> getPrices(List<String> tokens, List<String> currencies) throws TONAPIError {
     ...
     * @throws TONAPIError if the request fails
     */
    public CompletableFuture<ChartRates> getChart(String token, String currency, Long startDate, Long endDate, Integer pointsCount) throws TONAPIError {
