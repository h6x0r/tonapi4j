...
public class StakingMethod extends AsyncTonapiClientBase {
     ...
     * @throws TONAPIError if the request fails
     */
    public CompletableFuture<StakingPoolInfo> getPoolInfo(String accountId, String acceptLanguage) throws TONAPIError {
     ...
     * @throws TONAPIError if the request fails
     */
    public CompletableFuture<StakingPools> getAllNetworkPools(String availableFor, boolean includeUnverified, String acceptLanguage) throws TONAPIError {
