...
public class WalletMethod extends AsyncTonapiClientBase {
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<String> accountVerification(AddressProof addressProof)
      throws TONAPIError {
   ...
   *
   * @param bocParams      containing bag-of-cells serialized to base64/hex and additional
   *                       parameters to configure emulation
   ...
   * @throws TONAPIError if the request fails
   */
  public CompletableFuture<MessageConsequences> emulate(BocParams bocParams, String acceptLanguage)
      throws TONAPIError {
