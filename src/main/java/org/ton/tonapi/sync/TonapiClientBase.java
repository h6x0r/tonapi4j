...
public class TonapiClientBase {
     ...
     * @throws TONAPIError If the status code is not 2xx, deserialization fails, or the response is invalid.
     */
     ...
     * @throws TONAPIError If an error occurs during the request, such as network issues, non-2xx status codes, or deserialization failures.
     */
