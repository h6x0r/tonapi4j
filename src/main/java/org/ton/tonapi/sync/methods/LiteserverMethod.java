...
public class LiteserverMethod extends TonapiClientBase {
  ...
  public Long getTime() throws TONAPIError {
    ...
    Map<String, Object> response = this.get(method, null, null,
  ...
  public Integer sendMessage(String bodyMsg) throws TONAPIError {
    ...
    Map<String, Object> response = this.post(method, null, body, null,
        new TypeReference<Map<String, Object>>() {
        });
   ...
   * @throws TONAPIError if the request fails
   */
  public RawAccountState getAccountState(String accountAddress, String targetBlock)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public RawShardInfo getShardInfo(String blockId, long workchain, long shard, boolean exact)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public RawTransactions getRawTransactions(String accountId, long lt, String hash, int count)
      throws TONAPIError {
   ...
   * @throws TONAPIError if the request fails
   */
  public RawBlockProof getBlockProof(String knownBlock, int mode, String targetBlock)
      throws TONAPIError {
