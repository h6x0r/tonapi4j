...
public class WalletMethod extends TonapiClientBase {
  ...
  public String getBackupInfo(String xTonconnectAuth) throws TONAPIError {
    ...
    Map<String, Object> response = this.get(method, null, headers,
   ...
   *
   * @param bocParams      containing bag-of-cells serialized to base64/hex; Example ->
   *                       te6ccgECBQEAARUAAkWIAWTtae+KgtbrX26Bep8JSq8lFLfGOoyGR/xwdjfvpvEaHg and
   *                       additional parameters to configure emulation
   ...
   * @throws TONAPIError if the request fails
   */
  public MessageConsequences emulate(BocParams bocParams, String acceptLanguage)
      throws TONAPIError {
