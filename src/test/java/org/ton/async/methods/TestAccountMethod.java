...
public class TestAccountMethod extends AsyncTonapiTestBase {
  ...
  public void testGetBulkInfo() throws Exception {
    CompletableFuture<Accounts> future = tonapi.getAccounts()
        .getBulkInfo(Collections.singletonList(ACCOUNT_ID));
    ...
    for (Account a : response.getAccounts()) {
      ...
      System.out.println(
          "Account address (userfriendly and bounceable): " + a.getAddress().toUserFriendly(true));
      ...
      System.out.println(
          "Account balance (amount and precision 2): " + a.getBalance().toAmount(9, 2));
      System.out.println(
          "Account balance (amount and precision 3): " + a.getBalance().toAmount(9, 3));
      System.out.println(
          "Account balance (amount and precision 4): " + a.getBalance().toAmount(9, 4));
    }
  }
  ...
  public void testGetJettons() throws Exception {
    CompletableFuture<JettonsBalances> future = tonapi.getAccounts()
        .getJettonsBalances(ACCOUNT_ID, null, null);
  ...
  public void testGetJetton() throws Exception {
    ...
    CompletableFuture<JettonBalance> future = tonapi.getAccounts()
        .getJettonBalance(ACCOUNT_ID, JETTON_ID, currencies, supportedExtensions);
  ...
  public void testGetJettonsHistory() throws Exception {
    CompletableFuture<AccountEvents> future = tonapi.getAccounts()
        .getJettonsHistory(ACCOUNT_ID, LIMIT, null, ACCEPT_LANGUAGE_EN, null, null);
  ...
  public void testGetJettonsHistoryByJetton() throws Exception {
    CompletableFuture<AccountEvents> future = tonapi.getAccounts()
        .getJettonsHistoryByJetton(ACCOUNT_ID, JETTON_ID, LIMIT, null, ACCEPT_LANGUAGE_EN, null,
            null);
    AccountEvents response = future.get();
    assertNotNull(response);
  }
  ...
  public void testGetNfts() throws Exception {
    ...
    CompletableFuture<NftItems> future = tonapi.getAccounts()
        .getNfts(ACCOUNT_ID, LIMIT, OFFSET, collection, false);
  ...
  public void testGetAllNfts() throws Exception {
    CompletableFuture<NftItems> future = tonapi.getAccounts()
        .getAllNfts(ACCOUNT_ID, COLLECTION_ADDRESS, false, LARGE_LIMIT);
    NftItems response = future.get();
    assertNotNull(response);
  }
  ...
  public void testGetEvent() throws Exception {
    CompletableFuture<AccountEvent> future = tonapi.getAccounts()
        .getEvent(ACCOUNT_ID, EVENT_ID, ACCEPT_LANGUAGE_EN, false);
  ...
  public void testGetEvents() throws Exception {
    CompletableFuture<AccountEvents> future = tonapi.getAccounts()
        .getEvents(ACCOUNT_ID, LIMIT, BEFORE_LT, ACCEPT_LANGUAGE_EN, false, false, START_DATE,
            END_DATE);
    AccountEvents response = future.get();
    assertNotNull(response);
  }
  ...
  public void testGetNftHistory() throws Exception {
    CompletableFuture<AccountEvents> future = tonapi.getAccounts()
        .getNftHistory(ACCOUNT_ID, LIMIT, null, ACCEPT_LANGUAGE_EN, null, null);
    AccountEvents response = future.get();
    assertNotNull(response);
  }
  ...
  public void testGetBalanceChange() throws Exception {
    CompletableFuture<BalanceChange> future = tonapi.getAccounts()
        .getBalanceChange(ACCOUNT_ID, START_DATE, END_DATE);
