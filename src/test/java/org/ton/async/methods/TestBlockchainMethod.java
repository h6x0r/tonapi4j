...
public class TestBlockchainMethod extends AsyncTonapiTestBase {
    ...
    public void testGetBlock() throws Exception {
        CompletableFuture<BlockchainBlockShards> future = tonapi.getBlockchain().getBlock(MASTERCHAIN_SEQNO);
    ...
    public void testGetBlocks() throws Exception {
        CompletableFuture<BlockchainBlocks> future = tonapi.getBlockchain().getBlocks(MASTERCHAIN_SEQNO);
    ...
    public void testGetTransactionsShards() throws Exception {
        CompletableFuture<Transactions> future = tonapi.getBlockchain().getTransactionsShards(MASTERCHAIN_SEQNO);
    ...
    public void testGetBlockchainConfig() throws Exception {
        CompletableFuture<BlockchainConfig> future = tonapi.getBlockchain().getBlockchainConfig(MASTERCHAIN_SEQNO);
    ...
    public void testGetRawBlockchainConfig() throws Exception {
        CompletableFuture<RawBlockchainConfig> future = tonapi.getBlockchain().getRawBlockchainConfig(MASTERCHAIN_SEQNO);
    ...
    public void testGetTransactionFromBlock() throws Exception {
        CompletableFuture<Transactions> future = tonapi.getBlockchain().getTransactionFromBlock(BLOCK_ID);
        Transactions response = future.get();
        assertNotNull(response);
    }
    ...
    public void testGetTransactionData() throws Exception {
        CompletableFuture<Transaction> future = tonapi.getBlockchain().getTransactionData(TRANSACTION_ID);
    ...
    public void testGetTransactionByMessage() throws Exception {
        CompletableFuture<Transaction> future = tonapi.getBlockchain().getTransactionByMessage(MESSAGE_ID);
        Transaction response = future.get();
        assertNotNull(response);
    }
    ...
    public void testGetAccountInfo() throws Exception {
        CompletableFuture<BlockchainRawAccount> future = tonapi.getBlockchain().getAccountInfo(ACCOUNT_ID);
    ...
    public void testGetAccountTransactions() throws Exception {
        CompletableFuture<Transactions> future = tonapi.getBlockchain().getAccountTransactions(ACCOUNT_ID, AFTER_LT, BEFORE_LT, LIMIT);
        Transactions response = future.get();
        assertNotNull(response);
    }
    ...
    public void testInspectAccount() throws Exception {
        CompletableFuture<BlockchainAccountInspect> future = tonapi.getBlockchain().inspectAccount(ACCOUNT_ID);
    ...
    public void testExecuteGetMethod() throws Exception {
        CompletableFuture<MethodExecutionResult> future = tonapi.getBlockchain().executeGetMethod(ACCOUNT_ID_NFT, "get_nft_data");
