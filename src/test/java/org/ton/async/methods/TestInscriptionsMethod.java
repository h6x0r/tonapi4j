...
public class TestInscriptionsMethod extends AsyncTonapiTestBase {
    ...
    public void testGetAllInscriptions() throws Exception {
        CompletableFuture<InscriptionBalances> future = tonapi.getInscriptions().getAllInscriptions(ACCOUNT_ID, LIMIT, OFFSET);
    ...
    public void testGetInscriptionHistory() throws Exception {
        CompletableFuture<AccountEvents> future = tonapi.getInscriptions().getInscriptionHistory(ACCOUNT_ID, BEFORE_LT, LIMIT, ACCEPT_LANGUAGE_EN);
    ...
    public void testGetInscriptionHistoryByTicker() throws Exception {
        CompletableFuture<AccountEvents> future = tonapi.getInscriptions().getInscriptionHistoryByTicker(ACCOUNT_ID, TICKER, BEFORE_LT, LIMIT, ACCEPT_LANGUAGE_EN);
        AccountEvents response = future.get();
        assertNotNull(response);
    }
