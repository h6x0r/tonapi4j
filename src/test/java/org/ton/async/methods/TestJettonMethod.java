...
public class TestJettonMethod extends AsyncTonapiTestBase {
    ...
    public void testGetHolders() throws Exception {
        CompletableFuture<JettonHolders> future = tonapi.getJettons().getHolders(ACCOUNT_ID, LIMIT, OFFSET);
    ...
    public void testGetJettonTransferPayload() throws Exception {
        CompletableFuture<JettonTransferPayload> future = tonapi.getJettons().getJettonTransferPayload(ACCOUNT_ID, ACCOUNT_ID);
