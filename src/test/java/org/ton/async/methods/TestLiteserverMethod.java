...
public class TestLiteserverMethod extends AsyncTonapiTestBase {
  ...
  public void testGetAccountState() throws Exception {
    CompletableFuture<RawAccountState> future = tonapi.getLiteserver()
        .getAccountState(ACCOUNT_ID, null);
  ...
  public void testGetMasterchainInfoExt() throws Exception {
    CompletableFuture<RawMasterChainInfoExt> future = tonapi.getLiteserver()
        .getMasterchainInfoExt(MODE);
  ...
  public void testGetShardInfo() throws Exception {
    CompletableFuture<RawShardInfo> future = tonapi.getLiteserver()
        .getShardInfo(BLOCK_ID, WC, SHARD, true);
  ...
  public void testGetRawTransactions() throws Exception {
    CompletableFuture<RawTransactions> future = tonapi.getLiteserver()
        .getRawTransactions(ACCOUNT_ID, BEFORE_LT, TRANSACTION_ID, COUNT);
  ...
  public void testGetRawListBlockTransaction() throws Exception {
    CompletableFuture<RawListBlockTransactions> future = tonapi.getLiteserver()
        .getRawListBlockTransaction(BLOCK_ID, MODE, COUNT, ACCOUNT_ID, BEFORE_LT);
  ...
  public void testGetBlockProof() throws Exception {
    CompletableFuture<RawBlockProof> future = tonapi.getLiteserver()
        .getBlockProof(BLOCK_ID, MODE, null);
