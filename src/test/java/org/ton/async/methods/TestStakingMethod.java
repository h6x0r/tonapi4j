...
public class TestStakingMethod extends AsyncTonapiTestBase {
  ...
  public void testGetPoolInfo() throws Exception {
    CompletableFuture<StakingPoolInfo> future = tonapi.getStaking()
        .getPoolInfo(POOL_ID, ACCEPT_LANGUAGE_EN);
  ...
  public void testGetParticipatingPools() throws Exception {
    CompletableFuture<AccountStaking> future = tonapi.getStaking()
        .getParticipatingPools(ACCOUNT_ID);
  ...
  public void testGetAllNetworkPools() throws Exception {
    ...
    CompletableFuture<StakingPools> future = tonapi.getStaking()
        .getAllNetworkPools(ACCOUNT_ID, includeUnverified, acceptLanguage);
