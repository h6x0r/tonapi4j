...
public class TestWalletMethod extends AsyncTonapiTestBase {
    ...
    public void testAccountVerification() throws Exception {
        ...
        CompletableFuture<String> future = tonapi.getWallet().accountVerification(addressProof);
    ...
    public void testEmulate() throws Exception {
        ...
        CompletableFuture<MessageConsequences> future = tonapi.getWallet().emulate(bocParams, ACCEPT_LANGUAGE_EN);
