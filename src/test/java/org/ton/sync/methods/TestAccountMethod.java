...
public class TestAccountMethod extends TonapiTestBase {
  ...
  public void testGetJetton() {
    ...
    JettonBalance response = tonapi.getAccounts()
  ...
  public void testGetJettonsHistory() {
    AccountEvents response = tonapi.getAccounts()
  ...
  public void testGetAllNfts() {
    NftItems response = tonapi.getAccounts()
  ...
  public void testGetEvent() {
    AccountEvent response = tonapi.getAccounts()
  ...
  public void testGetBalanceChange() {
    BalanceChange response = tonapi.getAccounts()
