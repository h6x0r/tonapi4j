...
public class TestBlockchainMethod extends TonapiTestBase {
    ...
    public void testGetAccountTransactions() {
        Transactions response = tonapi.getBlockchain().getAccountTransactions(ACCOUNT_ID, AFTER_LT, BEFORE_LT, LIMIT);
        assertNotNull(response);
    }
    ...
    public void testExecuteGetMethod() {
        MethodExecutionResult response = tonapi.getBlockchain().executeGetMethod(ACCOUNT_ID_NFT, "get_nft_data");
        assertNotNull(response);
    }
}
